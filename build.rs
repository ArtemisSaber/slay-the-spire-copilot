...
const FILE_SIZE_ALLOWLIST: &[(&str, usize)] = &[
    ...
    ("src/journal.rs", 300),
    ("src/llm.rs", 785),
    ("src/locales/mod.rs", 335),
    ("src/main.rs", 778),
    ("src/postmortem.rs", 591),
    ("src/prompt/builder.rs", 1288),
    ("src/prompt/routing.rs", 443),
    ("src/ranker/context.rs", 482),
    ("src/ranker/engine.rs", 520),
    ("src/ranker/formula.rs", 357),
    ("src/ranker/parser.rs", 465),
    ("src/ranker/tests/context_tests.rs", 822),
    ("src/ranker/tests/parser_tests.rs", 475),
    ("src/setup_wizard.rs", 1344),
    ("src/startup.rs", 594),
    ("src/state.rs", 1261),
    ("src/tests/advice_tests.rs", 465),
    ("src/tests/combat_tests.rs", 491),
    ("src/tests/damage_tests.rs", 1225),
    ("src/tests/journal_tests.rs", 426),
