...
pub struct PostmortemLocale {
    ...
    pub section_route: String,
    pub section_rest_choices: String,
    pub section_shop: String,
    pub section_boss_relic: String,
    ...
    pub label_rest_entry: String,
    pub label_rest_rested: String,
    pub label_rest_smithed: String,
    pub label_shop_spent: String,
    pub label_shop_bought: String,
    pub label_shop_removed: String,
    pub label_boss_relic_entry: String,
    pub label_potion_used: String,
    pub section_final_combat: String,
    pub label_final_turn: String,
    pub label_final_enemy: String,
    pub label_final_ai: String,
    pub label_final_played: String,
    pub label_final_result: String,
